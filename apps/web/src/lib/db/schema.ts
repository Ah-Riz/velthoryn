...
export const leaves = pgTable(
  "leaves",
  {
    ...
    cliffTime: bigint("cliff_time", { mode: "number" }).notNull(),
...
export const claimEvents = pgTable(
  "claim_events",
  {
    ...
    leafIndex: integer("leaf_index").notNull(),
    amount: bigint("amount", { mode: "number" }).notNull(),
    totalClaimedByUser: bigint("total_claimed_by_user", { mode: "number" }).notNull(),
    totalClaimedOverall: bigint("total_claimed_overall", { mode: "number" }).notNull(),
