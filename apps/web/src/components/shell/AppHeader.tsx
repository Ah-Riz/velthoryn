    ...
    <header className="sticky top-0 z-20 flex h-14 items-center justify-between border-b border-[#1c2130] bg-[#0b0d12]/85 px-4 backdrop-blur-xl sm:h-16 sm:px-6">
      <div className="flex items-center gap-3">
        ...
        <button
          ...
          className="flex h-9 w-9 items-center justify-center rounded-lg border border-[#1c2130] bg-[#13161f] text-[#64748b] transition hover:border-[#2e3648] hover:text-[#b4b9c5] lg:hidden"
