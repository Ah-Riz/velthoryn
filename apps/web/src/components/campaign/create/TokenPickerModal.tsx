        ...
        >
          ...
          <div className="flex items-center justify-between px-5 pt-5 pb-3">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="rounded-full border border-white/[0.08] px-2.5 py-1 text-[10px] font-medium text-[#6b7280] transition hover:border-white/20 hover:text-white disabled:opacity-40"
              >
          ...
          {walletError && !walletLoading && (
            <div className="mx-5 flex items-center justify-between gap-2 rounded-lg border border-amber-500/20 bg-amber-500/5 px-3 py-2">
              <span className="text-[11px] text-amber-400">Wallet tokens unavailable — select from popular list or retry</span>
              <button
                type="button"
                onClick={() => void refetchWalletTokens()}
                className="shrink-0 text-[11px] text-violet-400 hover:text-violet-300 hover:underline"
              >
                Retry
              </button>
            </div>
